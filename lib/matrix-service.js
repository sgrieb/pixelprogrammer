...
MatrixService.prototype.setPixel = function (x, y, r, g, b) {
    this.matrix.setPixel(x, y, parseInt(r), parseInt(g), parseInt(b));
}
...
MatrixService.prototype.start = function() {
    var success = true;
...
MatrixService.prototype.stop = function() {
    var success = true;
